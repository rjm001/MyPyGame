...
# this one has bugs: ball can go off screen and movement change is funky if you go off screen
...
N_PIXELS_TO_MOVE = 3 #how many move if pushed
...
while True:
    ...
    ## 8A Inserting Drift
    # note that if you are off screen, the ball will move in opposite direction
